...
// Logo clásico de Java (taza de café con vapor). Colores tradicionales
// de la marca: azul #5382A1 (taza) y naranja #F89820 (vapor).
export function JavaIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 256 346" aria-hidden="true">
      ...
      <path
        fill="#F89820"
        d="M162 0s36 36-34 91-56 45-12 70 0 99-32-30-56-56-40-80 23-35 89-53 74-110"
      />
    </svg>
  );
}
